...
public class QuickQuoteFilterBuilder extends BaseQuoteFilterBuilder<QuickQuote> {
    /**
     ...
     */
    public QuickQuoteFilterBuilder(BaseDAO<QuickQuote> dao, User authenticatedUser, Request request) {
