...
public class BookQuoteFilterBuilder extends BaseQuoteFilterBuilder<BookQuote> {
    /**
     ...
     */
    public BookQuoteFilterBuilder(BaseDAO<BookQuote> dao, User authenticatedUser, Request request) {
